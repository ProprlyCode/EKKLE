...
| 4 | `sanctuary.*` · `sanctuary-mobile.*` | S4, S5, S6, S7 | The same architectural language fully resolved **warm/brass**; no prominent figures. A backdrop that reads behind text. | 2560×1440 | 1080×1920 | Warm glow, low-contrast center. Reused across four scenes (dimmed differently in each). |
